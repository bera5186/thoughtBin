...
class Post(models.Model):
    ...
    slug = models.CharField(max_length=400, unique=True, db_index=True, default=uuid.uuid4)
...
class Comment(models.Model):
    ...
    author_reply = models.TextField(max_length=1000, default=None, null=True, blank=True)
